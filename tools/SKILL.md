---
name: pxdca-pdca
description: Guide an AI to distinguish traditional Plan-Do-Check-Act from PxDCA's project-specific Problem/Purpose-Design-Check/Challenge-Action model, assess whether current requirement, specification, and architecture context is sufficient for the requested software work, and correctly use PxDCA when information is insufficient and the user agrees. Use for software planning, implementation, change, review, or recovery work that may benefit from PxDCA.
---
...
### PxDCA project definition

PxDCA borrows the idea of a cycle but defines its letters for software development and AI work:
...
Do not present the PxDCA definition as the original management PDCA. Use the original PDCA spirit to assess and improve the current task; use the PxDCA definition to understand the software artifacts produced by PxDCA.
